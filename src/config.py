...
from mrich import  print as printc
...
def make():
    if checkConfig():
	    printc("[red][!] Already Configured!  [/green]")
	    return
    ...
    #CREATE tables
    query = "CREATE TABLE pm.secrets (masterkey_hash TEXT NOT NULL, device_secrets TEXT NOT NULL)"
